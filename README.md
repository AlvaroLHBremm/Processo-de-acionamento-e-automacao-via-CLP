...
bidirecional, bomba de saída e eletroválvula de entrada. Projeto deenvolvido utilizando simulador PLC `CADe SIMU` e CLP `WEG Clic-02/20VR-D` 
durante diciplina `Maquinas e acionametos` e aplicado em prática em bancada na disciplina de `Automação Industrial`.
