...
bidirecional, bomba de saída e eletroválvula de entrada. Projeto deenvolvido utilizando simulador PLC `CADe SIMU` 
durante diciplina `Maquinas e acionametos` e `Automação Industrial`.
...
Para simular a ativação dos cmponentes foram utilizados lEDs como saida. 
